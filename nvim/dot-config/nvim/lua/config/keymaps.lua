...
-- move lines up and down in visual/normal mode
...
-- keymap for moving up and down half a page but keep it centered
keymap.set("n", "<C-d>", "<C-d>zz") -- move down half a page ; then center
keymap.set("n", "<C-u>", "<C-u>zz") -- move up half a page ; then center
